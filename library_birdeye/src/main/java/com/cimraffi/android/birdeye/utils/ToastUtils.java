...
public class ToastUtils {
    ...
    private static void showMessage(Pair<TextView, String> msg) {
        if (msg != null) {
            if (msg.first == null) {
                Toast.makeText(ApplicationFactory.getInstance().getBaseContext(),
                        "tv is null", Toast.LENGTH_SHORT).show();
            } else {
    ...
    public static void showToast(String msg) {
        Toast.makeText(ApplicationFactory.getInstance().getBaseApplication(), msg, Toast.LENGTH_SHORT).show();
    }
