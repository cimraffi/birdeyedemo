...
public interface AirMapInterface {
  ...
  void addXVI(String xviId);
  void addTiff(String ws, String layer,long taskId);
  void addTiffNotClear(String ws, String layer,long taskId);
  void addBinaryTiff(String ws, String layer);
  /**
  ...
  void addOverlay(AirMapMarker<?> marker);
  void moveOverlay(AirMapMarker<?> marker, LatLng to, double rotate);
  void rotateOverlay(AirMapMarker<?> marker, double rotate);

  /**
   * Add the given marker as text to the map
   *
   * @param marker {@link AirMapMarker} instance to add
   */
  void addText(AirMapMarker<?> marker);
   ...
   * @param to {@link LatLng} new destination of the marker
   */
  void setPhoneMarker(AirMapMarker<?> marker);
  ...
  <T> void setOptions(AirMapPolygon<T> polygon, int rotate, int space, OnSetOptionsCallback callback);
  ...
  void setOnPositionCallback(OnPositionCallback callback);

  void setOnPositionCallback(boolean modify,OnPositionCallback callback);
