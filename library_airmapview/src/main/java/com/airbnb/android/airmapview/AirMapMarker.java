...
import com.airbnb.android.airmapview.MapUtils.BitmapDescriptor;
import com.airbnb.android.airmapview.MapUtils.BitmapDescriptorFactory;
import com.airbnb.android.airmapview.MapUtils.LatLng;
import com.airbnb.android.airmapview.MapUtils.Marker;
import com.airbnb.android.airmapview.MapUtils.MarkerOptions;
...
public class AirMapMarker<T> {
  ...
  public Builder<T> toBuilder() {
    ...
    if(markerOptions.getTitle()!=null){
      builder.title(markerOptions.getTitle());
    }
    if (divIcon != null) {
